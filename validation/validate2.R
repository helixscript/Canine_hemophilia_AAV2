...
config$bwa.path <- '/home/everett/ext/bwa'
config$vectorDB.blat.path <- '/home/everett/projects/canine_hemophilia_AAV/data/sequenceData/vectorSeqs_ITR_to_ITR.2bit'
config$vectorDB.bwa.path <- '/home/everett/projects/canine_hemophilia_AAV/data/sequenceData/vectorSeqs_ITR_to_ITR'
...
contigs <- lapply(c(1, 2, 3), function(n){
...
invisible(lapply(split(o, o$contigID.x), function(x){
  ...
  ggsave(p, file = paste0(title, '.pdf'), height = 8, units = 'in')
}))
...
write(c('new',
        'genome /home/everett/projects/canine_hemophilia_AAV/data/sequenceData/vectorSeqs_ITR_to_ITR.genome',
